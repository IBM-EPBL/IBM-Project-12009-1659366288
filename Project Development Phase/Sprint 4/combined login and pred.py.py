...
def signup():
 ...
 Entry(root2, textvariable=password_verification, show="*").pack()
 Label(root2, text="").pack()
 Button(root2, text="Login", bg="purple", fg='white', relief="groove", font=('arial', 12, 'bold'),command=login).pack()
 Label(root2, text="")
...
def logged():
 ...
 Button(logged_message, text="Prediction page", bg="purple", fg='white', relief="groove", font=('arial', 12, 'bold'), command=pred).pack()
